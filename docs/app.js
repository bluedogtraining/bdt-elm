...
var _bluedogtraining$bdt_elm$Form_Select_Internal$closed = F2(
	function (state, viewState) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('bdt-elm select-container'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
												_elm_lang$html$Html_Events$onFocus(_bluedogtraining$bdt_elm$Form_Select_Internal$Open),
												!viewState.isLocked),
											_1: {
												ctor: '::',
												_0: A2(
													_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
													_elm_lang$html$Html_Events$onClick(_bluedogtraining$bdt_elm$Form_Select_Internal$Open),
													!viewState.isLocked),
												_1: {ctor: '[]'}
											}
										}
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('option-label'),
								_1: {
									ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('expand_more'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _bluedogtraining$bdt_elm$Form_Select_Internal$optionList = F2(
	function (state, viewState) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('option-list'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarWeekDay = function (day) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('week-day-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$clearDateButton = function (state) {
	...
	if (_p9.ctor === 'Nothing') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('clear currently selected date'),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('clear-button active'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Clear),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDay = F4(
	function (state, viewState, firstOfMonth, _p10) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('calendar-day-item'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$classList(
						{
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDayRow = F4(
	function (state, viewState, firstOfMonth, row) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('calendar-day-row'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDays = F3(
	function (state, viewState, navigationDate) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('calendar-day-list'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
	...
	function (viewState, navigationDate) {
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('material-icons month-arrows'),
					_1: {
						ctor: '::',
						_0: A2(
							_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
							_elm_lang$html$Html_Events$onClick(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$NextMonth),
							!isDisabled),
						_1: {ctor: '[]'}
					}
				}
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('chevron_right'),
				_1: {ctor: '[]'}
			});
	});
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$nextYearArrow = F2(
	function (viewState, navigationDate) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('year-arrows'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$classList(
						{
			...
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
							_elm_lang$html$Html_Events$onClick(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$PreviousMonth),
							!isDisabled),
						_1: {ctor: '[]'}
					}
				}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$closed = F2(
	function (state, viewState) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('bdt-elm datepicker-container'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$timePicker = F2(
	function (time, selectedDate) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('timepicker-container'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('select-container'),
						_1: {
							ctor: '::',
							_0: A2(
								_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('colon'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('apply-button-container'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('apply-button'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$classList(
															{
														...
														_1: {
															...
															_0: A2(
																_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
																_elm_lang$html$Html_Events$onClick(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Apply),
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('week-day-list'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$Input),
								_1: {
									ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$render = F2(
	function (state, viewState) {
		return A3(_elm_lang$html$Html_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_FloatInput_Internal$inputField, state, viewState);
	});
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_bluedogtraining$bdt_elm$Form_IntInput_Internal$Input),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder(viewState.placeholder),
									_1: {
...
var _bluedogtraining$bdt_elm$Form_IntInput_Internal$render = F2(
	function (state, viewState) {
		return A3(_elm_lang$html$Html_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_IntInput_Internal$inputField, state, viewState);
	});
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('input option-label-container'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$classList(
								{
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
										_elm_lang$html$Html_Events$onFocus(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Open),
										!viewState.isLocked),
									_1: {ctor: '[]'}
								}
							}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('input option-label'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$tabindex(-1),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onBlur(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Blur),
								_1: {
									ctor: '::',
									_0: _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$onKeyboardInput(
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$infoMessageContainer = function (message) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('info-message'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
													_elm_lang$html$Html_Events$onFocus(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Open),
													!viewState.isLocked),
												_1: {
													ctor: '::',
													_0: A2(
														_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
														_elm_lang$html$Html_Events$onClick(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Open),
														!viewState.isLocked),
													_1: {
														ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResultItem = F3(
	function (focusedOption, toLabel, option) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('search-result-item'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$classList(
						{
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResultList = F2(
	function (state, viewState) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('search-result-list'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
