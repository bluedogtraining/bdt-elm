...
var _bluedogtraining$bdt_elm$Colors$error = _rtfeldman$elm_css$Css$hex('d9534f');
...
var _bluedogtraining$bdt_elm$Html_Bdt$viewIf = F2(
	function (show, view) {
		return show ? view : _rtfeldman$elm_css$Html_Styled$text('');
	});
var _bluedogtraining$bdt_elm$Html_Bdt$divIf = F3(
	function (show, attributes, children) {
		return A2(
			...
			show,
			A2(_rtfeldman$elm_css$Html_Styled$div, attributes, children));
	});
						...
						_1: {
							...
							_1: {
								...
								_0: _rtfeldman$elm_css$Css$backgroundColor(
									isDisabled ? _rtfeldman$elm_css$Css$hex('eceeef') : (((!isDisabled) && isHovered) ? _rtfeldman$elm_css$Css$hex('dddddd') : _rtfeldman$elm_css$Css$hex('ffffff'))),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$hover(
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$backgroundColor(
												(!isDisabled) ? _rtfeldman$elm_css$Css$hex('f6f6f6') : _rtfeldman$elm_css$Css$hex('ffffff')),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _bluedogtraining$bdt_elm$Form_Select_Css$optionList = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_Select_Css$optionText = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_Select_Css$optionTextContainer = F2(
	function (isLocked, isError) {
		return _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						isLocked ? A3(_rtfeldman$elm_css$Css$rgb, 245, 245, 245) : A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 255)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$borderColor(
							isError ? _bluedogtraining$bdt_elm$Colors$error : _rtfeldman$elm_css$Css$hex('dddddd')),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$cursor(
...
var _bluedogtraining$bdt_elm$Form_Select_Internal$focusNextOption = F2(
	function (options, option) {
		var maybeNextOption = _elm_lang$core$List$head(
			A2(
...
var _bluedogtraining$bdt_elm$Form_Select_Internal$focusOption = F2(
	function (options, option) {
		var _p1 = A2(_elm_lang$core$List$member, option, options);
		if (_p1 === true) {
			return option;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
	...
	function (state, isOptionDisabled, keyboardInput) {
		...
		if (_p3.ctor === 'Nothing') {
			...
			switch (_p4.ctor) {
				...
				case 'Up':
					var newFocusedOption = A2(_bluedogtraining$bdt_elm$Form_Select_Internal$focusPreviousOption, state.options, _p7);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
				...
				default:
					var newFocusedOption = A2(_bluedogtraining$bdt_elm$Form_Select_Internal$focusNextOption, state.options, _p7);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
			...
			switch (_p9.ctor) {
				...
				case 'Clear':
					return A2(
						...
						{ctor: '[]'});
				case 'KeyboardInput':
					return A3(_bluedogtraining$bdt_elm$Form_Select_Internal$handleKeyboardInput, state, _p9._0, _p9._1);
				case 'Focus':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
							{
								focusedOption: _elm_lang$core$Maybe$Just(
									A2(_bluedogtraining$bdt_elm$Form_Select_Internal$focusOption, state.options, _p9._0))
							}),
						{ctor: '[]'});
				case 'BlurOption':
...
var _bluedogtraining$bdt_elm$Form_Select_Internal$clearButton = F2(
	function (state, viewState) {
		return A3(
			_bluedogtraining$bdt_elm$Html_Bdt$divIf,
			viewState.isClearable && (!_elm_lang$core$Native_Utils.eq(
				_bluedogtraining$bdt_elm$Resettable$getValue(state.selectedOption),
				_elm_lang$core$Maybe$Nothing)),
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons glyphicons-remove'),
				_1: {
					ctor: '::',
					_0: A3(
						_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
			...
			A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_bluedogtraining$bdt_elm$Form_Select_Css$optionTextContainer, viewState.isLocked, viewState.isError),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('form-control'),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(
										A2(_elm_lang$core$Maybe$withDefault, '', viewState.id)),
									_1: {
										ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _bluedogtraining$bdt_elm$Form_Select_Css$optionText,
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: A3(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons glyphicons-chevron-down'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
...
var _bluedogtraining$bdt_elm$Form_Select_Internal$isSelectInputKey = F2(
	function (msg, code) {
		...
		var _p12 = A2(_elm_lang$core$Dict$get, code, dict);
		if (_p12.ctor === 'Just') {
						...
						_rtfeldman$elm_css$Html_Styled$div,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(
										_bluedogtraining$bdt_elm$Form_Helpers$toHtmlId(viewState.id)),
									_1: {
										ctor: '::',
										_0: _bluedogtraining$bdt_elm$Form_Select_Internal$onKeyboardInput(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$isTimeFocused = function (time) {
	return !_elm_lang$core$Native_Utils.eq(time.focusedSelect, _elm_lang$core$Maybe$Nothing);
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$selectToLabel = function (selected) {
	return selected;
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$isSelectOpen = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$List$any,
		F2(
		...
		A2(
			_elm_lang$core$List$map,
			_bluedogtraining$bdt_elm$Form_Select$getIsOpen,
			{
				ctor: '::',
				_0: _p1.hours,
				_1: {
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$intsToStrings = function (ints) {
	return A2(
		_elm_lang$core$List$map,
		function (_p2) {
			return A3(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$dateFromTime = function (time) {
	var _p3 = time.selectedDate;
	if (_p3.ctor === 'Nothing') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		var _p7 = _p3._0;
		var second = A2(
			...
			A2(
				...
				A2(
					...
					_bluedogtraining$bdt_elm$Form_Select$getSelectedOption(time.seconds))));
		var minute = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(
				...
				A2(
					...
					_bluedogtraining$bdt_elm$Form_Select$getSelectedOption(time.minutes))));
		var hour = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(
				...
				A2(
					...
					_bluedogtraining$bdt_elm$Form_Select$getSelectedOption(time.hours))));
		var day = _elm_lang$core$Date$day(_p7);
		var month = _elm_lang$core$Date$month(_p7);
		var year = _elm_lang$core$Date$year(_p7);
		return _elm_lang$core$Maybe$Just(
			A7(_rluiten$elm_date_extra$Date_Extra_Create$dateFromFields, year, month, day, hour, minute, second, 0));
	}
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$dateAtDayNumber = F2(
	function (dayNumber, date) {
		return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Day, dayNumber - 1, date);
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$nextYear = function (date) {
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, 12, date);
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$nextMonth = function (date) {
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, 1, date);
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$previousMonth = function (date) {
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, -1, date);
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$visibleDays = function (navigationDate) {
	var daysInPreviousMonth = _rluiten$elm_date_extra$Date_Extra_Core$daysInMonthDate(
		_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$previousMonth(navigationDate));
	var daysInMonth = _rluiten$elm_date_extra$Date_Extra_Core$daysInMonthDate(navigationDate);
	var currentMonth = A2(
		_elm_lang$core$List$map,
		F2(
			function (v0, v1) {
	...
	var firstOfMonth = _rluiten$elm_date_extra$Date_Extra_Core$toFirstOfMonth(navigationDate);
	var startNumber = _rluiten$elm_date_extra$Date_Extra_Core$isoDayOfWeek(
		_elm_lang$core$Date$dayOfWeek(firstOfMonth));
	var tailOfPreviousMonth = A2(
		...
		A2(
			...
			A2(_elm_lang$core$List$range, 1, daysInPreviousMonth)));
	var headOfNextMonth = A2(
		...
		A2(_elm_lang$core$List$range, 1, ((6 * 7) - startNumber) - daysInMonth));
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			tailOfPreviousMonth,
			A2(_elm_lang$core$Basics_ops['++'], currentMonth, headOfNextMonth)));
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$previousYear = function (date) {
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, -12, date);
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$clamp = F3(
	function (minDate, maxDate, date) {
		return A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$Before, date, minDate) ? minDate : (A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$After, date, maxDate) ? maxDate : date);
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$maybeClamp = F3(
	function (maybeMinDate, maybeMaxDate, date) {
		var _p8 = {ctor: '_Tuple2', _0: maybeMinDate, _1: maybeMaxDate};
		_v2_3:
		do {
			if (_p8.ctor === '_Tuple2') {
				if (_p8._0.ctor === 'Just') {
					if (_p8._1.ctor === 'Just') {
						return A3(_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$clamp, _p8._0._0, _p8._1._0, date);
					} else {
						return A3(_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$clamp, _p8._0._0, date, date);
					}
				} else {
					if (_p8._1.ctor === 'Just') {
						return A3(_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$clamp, date, _p8._1._0, date);
					} else {
						break _v2_3;
					}
				}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$monthToStringNumber = function (month) {
	var _p9 = month;
	switch (_p9.ctor) {
		case 'Jan':
			return '01';
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$monthToString = function (month) {
	var _p10 = month;
	switch (_p10.ctor) {
		case 'Jan':
			return 'January';
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$dateToString = function (date) {
	var year = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$year(date));
	var month = _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$monthToStringNumber(
		_elm_lang$core$Date$month(date));
	var day = A3(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$timeToString = function (date) {
	return _elm_lang$core$String$concat(
		A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$core$Date$hour(date),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Date$minute(date),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Date$second(date),
							_1: {ctor: '[]'}
						}
					}
				})));
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$toTimeLabel = function (date) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$dateToString(date),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$timeToString(date)));
};
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$clearDateButton = function (isActive) {
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						_rtfeldman$elm_css$Css$color(
							_rtfeldman$elm_css$Css$hex('333333')),
						isActive),
					_1: {
						ctor: '::',
						_0: A2(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$clearDateContainer = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_bluedogtraining$bdt_elm$Css_Bdt_ops['?'],
							_rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$notAllowed),
							!isActive),
						_1: {
							ctor: '::',
							_0: A2(
								_bluedogtraining$bdt_elm$Css_Bdt_ops['?'],
								_rtfeldman$elm_css$Css$backgroundColor(
									_rtfeldman$elm_css$Css$hex('2ECC71')),
								isActive),
							_1: {
								ctor: '::',
								_0: A2(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$timePickerColon = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$timePickerSelect = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$timePickerSelectContainer = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarDay = F3(
															...
															_1: {
																...
																_1: {
																	...
																	_0: A2(
																		...
																		isSelectable && isSelectedTimeDate),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			_bluedogtraining$bdt_elm$Css_Bdt_ops['?'],
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarDays = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{ctor: '[]'});
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarWeekDay = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$flex2,
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(
							_rtfeldman$elm_css$Css$hex('999999')),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$textAlign(_rtfeldman$elm_css$Css$center),
							_1: {ctor: '[]'}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarWeekDays = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
			_rtfeldman$elm_css$Css$border3,
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationYearArrow = function (isDisabled) {
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
			_0: A2(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationYearArrowContainer = function (isDisabled) {
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
			_0: A2(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationMonthArrow = function (isDisabled) {
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
			_0: A2(
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationDate = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$flexGrow(
			_rtfeldman$elm_css$Css$int(1)),
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$color(
						_rtfeldman$elm_css$Css$hex('444444')),
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigation = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {ctor: '[]'}
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendar = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
			_rtfeldman$elm_css$Css$border3,
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$selectContainerDate = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$flexGrow(
			_rtfeldman$elm_css$Css$int(1)),
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$selectContainer = F3(
	function (isLocked, isInput, isError) {
		var _p0 = isInput;
		if (_p0 === true) {
			return _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					...
					_1: {
						...
						_0: _rtfeldman$elm_css$Css$important(
							_rtfeldman$elm_css$Css$borderColor(
								isError ? _bluedogtraining$bdt_elm$Colors$error : _rtfeldman$elm_css$Css$hex('dddddd'))),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$cursor(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										_bluedogtraining$bdt_elm$Css_Bdt_ops['?'],
										_rtfeldman$elm_css$Css$color(_bluedogtraining$bdt_elm$Colors$error),
										isError),
									_1: {ctor: '[]'}
								}
							}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Css$container = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$flexGrow(
			_rtfeldman$elm_css$Css$int(1)),
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getId = function (_) {
	return _.id;
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getSelectedDate = function (_p0) {
	return _bluedogtraining$bdt_elm$Resettable$getValue(
		function (_) {
			return _.selectedDate;
		}(_p0));
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getInitialDate = function (_p1) {
	return _bluedogtraining$bdt_elm$Resettable$getInitialValue(
		function (_) {
			return _.selectedDate;
		}(_p1));
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getIsOpen = function (_) {
	return _.isOpen;
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getIsChanged = function (_p2) {
	return _bluedogtraining$bdt_elm$Resettable$getIsChanged(
		function (_) {
			return _.selectedDate;
		}(_p2));
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setId = F2(
	function (id, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setToLabel = F2(
	function (toLabel, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{toLabel: toLabel});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setDefaultLabel = F2(
	function (defaultLabel, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{defaultLabel: defaultLabel});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsInput = F2(
	function (isInput, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isInput: isInput});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsClearable = F2(
	function (isClearable, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isClearable: isClearable});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsLocked = F2(
	function (isLocked, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isLocked: isLocked});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsError = F2(
	function (isError, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isError: isError});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIncludeTime = F2(
	function (includeTime, viewState) {
		var _p3 = includeTime;
		if (_p3 === true) {
			return _elm_lang$core$Native_Utils.update(
				viewState,
				{includeTime: true, toLabel: _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$toTimeLabel});
		} else {
			return _elm_lang$core$Native_Utils.update(
				viewState,
				{includeTime: false, toLabel: _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$toLabel});
		}
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setMaxDate = F2(
	function (date, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{maxDate: date});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setMinDate = F2(
	function (date, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{minDate: date});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setSelectedDate = F2(
	function (selectedDate, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
				selectedDate: A2(_bluedogtraining$bdt_elm$Resettable$update, selectedDate, state.selectedDate)
			});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$setInitialDate = F2(
	function (selectedDate, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
				selectedDate: _bluedogtraining$bdt_elm$Resettable$init(selectedDate)
			});
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$reset = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			selectedDate: _bluedogtraining$bdt_elm$Resettable$reset(state.selectedDate)
		});
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$reInitialise = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			selectedDate: _bluedogtraining$bdt_elm$Resettable$init(
				_bluedogtraining$bdt_elm$Resettable$getValue(state.selectedDate))
		});
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarWeekDay = function (day) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarWeekDay,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text(day),
			_1: {ctor: '[]'}
		});
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarNavigationTitle = function (date) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$year(date)),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' - ',
			_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$monthToString(
				_elm_lang$core$Date$month(date))));
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$apply = function (state) {
	var time = state.time;
	var _p4 = time.selectedDate;
	if (_p4.ctor === 'Nothing') {
		return _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$dateFromTime(
			_elm_lang$core$Native_Utils.update(
				time,
				{
					selectedDate: _bluedogtraining$bdt_elm$Resettable$getValue(state.selectedDate)
				}));
	} else {
		return _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$dateFromTime(time);
	}
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$initNavigationDate = F3(
	function (minDate, maxDate, date) {
		return _elm_lang$core$Maybe$Just(
			A3(_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$maybeClamp, minDate, maxDate, date));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$initialTime = function (formValue) {
	var selectedDate = _bluedogtraining$bdt_elm$Resettable$getValue(formValue);
	var defaultHours = _elm_lang$core$Maybe$Just(
		A2(
			_elm_lang$core$Maybe$withDefault,
			'00',
			A2(
				...
				function (_p5) {
					return A3(
						...
						_elm_lang$core$Native_Utils.chr('0'),
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Date$hour(_p5)));
				},
				selectedDate)));
	var hours = A2(
		_bluedogtraining$bdt_elm$Form_Select$setInitialOption,
		defaultHours,
		_bluedogtraining$bdt_elm$Form_Select$init(
			_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$intsToStrings(
				A2(_elm_lang$core$List$range, 0, 23))));
	var defaultMinutes = _elm_lang$core$Maybe$Just(
		A2(
			_elm_lang$core$Maybe$withDefault,
			'00',
			A2(
				...
				function (_p6) {
					return A3(
						...
						_elm_lang$core$Native_Utils.chr('0'),
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Date$minute(_p6)));
				},
				selectedDate)));
	var minutes = A2(
		_bluedogtraining$bdt_elm$Form_Select$setInitialOption,
	...
	var defaultSeconds = _elm_lang$core$Maybe$Just(
		A2(
			_elm_lang$core$Maybe$withDefault,
			'00',
			A2(
				...
				function (_p7) {
					return A3(
						...
						_elm_lang$core$Native_Utils.chr('0'),
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Date$second(_p7)));
				},
				selectedDate)));
	var seconds = A2(
		_bluedogtraining$bdt_elm$Form_Select$setInitialOption,
		...
		_bluedogtraining$bdt_elm$Form_Select$init(
			_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$intsToStrings(
				A2(_elm_lang$core$List$range, 0, 59))));
	return {hours: hours, minutes: minutes, seconds: seconds, focusedSelect: _elm_lang$core$Maybe$Nothing, selectedDate: _elm_lang$core$Maybe$Nothing};
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$initialViewState = {isLocked: false, isError: false, isClearable: false, isInput: true, minDate: _elm_lang$core$Maybe$Nothing, maxDate: _elm_lang$core$Maybe$Nothing, toLabel: _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$toLabel, defaultLabel: '-- Nothing Selected --', includeTime: false, id: _elm_lang$core$Maybe$Nothing};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$init = {
	isOpen: false,
	selectedDate: _bluedogtraining$bdt_elm$Resettable$init(_elm_lang$core$Maybe$Nothing),
	navigationDate: _elm_lang$core$Maybe$Nothing,
	time: _bluedogtraining$bdt_elm$Form_DatePicker_Internal$initialTime(
		_bluedogtraining$bdt_elm$Resettable$init(_elm_lang$core$Maybe$Nothing))
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$State = F4(
	function (a, b, c, d) {
		return {isOpen: a, selectedDate: b, navigationDate: c, time: d};
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$ViewState = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {isLocked: a, isError: b, isClearable: c, isInput: d, minDate: e, maxDate: f, toLabel: g, defaultLabel: h, includeTime: i, id: j};
									};
								};
							};
						};
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$Time = F5(
	function (a, b, c, d, e) {
		return {hours: a, minutes: b, seconds: c, focusedSelect: d, selectedDate: e};
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$Seconds = {ctor: 'Seconds'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$Minutes = {ctor: 'Minutes'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$Hours = {ctor: 'Hours'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$DomFocus = function (a) {
	return {ctor: 'DomFocus', _0: a};
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$openTimeSelect = function (timeSelect) {
	var _p8 = timeSelect;
	switch (_p8.ctor) {
		case 'Hours':
			return A2(
				_elm_lang$core$Task$attempt,
				_bluedogtraining$bdt_elm$Form_DatePicker_Internal$DomFocus,
				_elm_lang$dom$Dom$focus('FORM_DATEPICKER_HOURS'));
		case 'Minutes':
			return A2(
				_elm_lang$core$Task$attempt,
				_bluedogtraining$bdt_elm$Form_DatePicker_Internal$DomFocus,
				_elm_lang$dom$Dom$focus('FORM_DATEPICKER_MINUTES'));
		default:
			return A2(
				_elm_lang$core$Task$attempt,
				_bluedogtraining$bdt_elm$Form_DatePicker_Internal$DomFocus,
				_elm_lang$dom$Dom$focus('FORM_DATEPICKER_SECONDS'));
	}
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$NoOp = {ctor: 'NoOp'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$disableMouseDown = A3(
	_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
	'mousedown',
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$clearDateButton = function (state) {
	...
	if (_p9.ctor === 'Nothing') {
		return A2(
			...
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$clearDateButton(false),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$clearDateButton(true),
				_1: {
					ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$clearDateContainer = F2(
	function (state, viewState) {
		return A3(
			...
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$clearDateContainer,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$SelectDay = F2(
	function (a, b) {
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDay = F4(
	function (state, viewState, firstOfMonth, _p10) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A3(_bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarDay, isSelected, isSelectedTimeDate, _p15 && isInRange),
				_1: {
					ctor: '::',
					_0: A2(
						_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDayRow = F4(
	function (state, viewState, firstOfMonth, row) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarDayRow,
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A3(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDay, state, viewState, firstOfMonth),
				row));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDays = F3(
	function (state, viewState, navigationDate) {
		var firstOfMonth = _rluiten$elm_date_extra$Date_Extra_Core$toFirstOfMonth(navigationDate);
		var rows = _bluedogtraining$bdt_elm$Form_DatePicker_Helpers$visibleDays(navigationDate);
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarDays,
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A3(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarDayRow, state, viewState, firstOfMonth),
				rows));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$NextMonth = {ctor: 'NextMonth'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$nextMonthArrow = F2(
	function (viewState, navigationDate) {
		var isDisabled = _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Date$year, viewState.maxDate),
			_elm_lang$core$Maybe$Just(
				_elm_lang$core$Date$year(navigationDate))) && _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Date$month, viewState.maxDate),
			_elm_lang$core$Maybe$Just(
				_elm_lang$core$Date$month(navigationDate)));
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationMonthArrow(isDisabled),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons glyphicons-chevron-right'),
					_1: {
						ctor: '::',
						_0: A2(
							_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
							_rtfeldman$elm_css$Html_Styled_Events$onClick(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$NextMonth),
							!isDisabled),
						_1: {ctor: '[]'}
					}
				}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$NextYear = function (a) {
	return {ctor: 'NextYear', _0: a};
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$nextYearArrow = F2(
	function (viewState, navigationDate) {
		var isDisabled = _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Date$year, viewState.maxDate),
			_elm_lang$core$Maybe$Just(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationYearArrowContainer(isDisabled),
				_1: {
					ctor: '::',
					_0: A2(
						_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
						_rtfeldman$elm_css$Html_Styled_Events$onClick(
							_bluedogtraining$bdt_elm$Form_DatePicker_Internal$NextYear(viewState.maxDate)),
						!isDisabled),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationYearArrow(isDisabled),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons glyphicons-chevron-right'),
							_1: {ctor: '[]'}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$PreviousMonth = {ctor: 'PreviousMonth'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$previousMonthArrow = F2(
	function (viewState, navigationDate) {
		var isDisabled = _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Date$year, viewState.minDate),
			_elm_lang$core$Maybe$Just(
				_elm_lang$core$Date$year(navigationDate))) && _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Date$month, viewState.minDate),
			_elm_lang$core$Maybe$Just(
				_elm_lang$core$Date$month(navigationDate)));
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons glyphicons-chevron-left'),
					_1: {
						ctor: '::',
						_0: A2(
							_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
							_rtfeldman$elm_css$Html_Styled_Events$onClick(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$PreviousMonth),
							!isDisabled),
						_1: {ctor: '[]'}
					}
				}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$PreviousYear = function (a) {
	return {ctor: 'PreviousYear', _0: a};
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$previousYearArrow = F2(
	function (viewState, navigationDate) {
		var isDisabled = _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Date$year, viewState.minDate),
			_elm_lang$core$Maybe$Just(
			...
			_rtfeldman$elm_css$Html_Styled$div,
			{
				...
				_1: {
					...
					_0: A2(
						_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
						_rtfeldman$elm_css$Html_Styled_Events$onClick(
							_bluedogtraining$bdt_elm$Form_DatePicker_Internal$PreviousYear(viewState.minDate)),
						!isDisabled),
					_1: {ctor: '[]'}
				}
			},
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarNavigation = F3(
	function (state, viewState, navigationDate) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigation,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$previousYearArrow, viewState, navigationDate),
				_1: {
					ctor: '::',
					_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$previousMonthArrow, viewState, navigationDate),
					_1: {
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$div,
							{
								ctor: '::',
								_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarNavigationDate,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text(
									_bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarNavigationTitle(navigationDate)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$nextMonthArrow, viewState, navigationDate),
							_1: {
								ctor: '::',
								_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$nextYearArrow, viewState, navigationDate),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$InitWithCurrentDate = F3(
	function (a, b, c) {
		return {ctor: 'InitWithCurrentDate', _0: a, _1: b, _2: c};
	});
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$Blur = {ctor: 'Blur'};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$Open = F3(
	function (a, b, c) {
		return {ctor: 'Open', _0: a, _1: b, _2: c};
	});
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$closed = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				_rtfeldman$elm_css$Html_Styled$div,
				{
					ctor: '::',
					_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$container,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A3(_bluedogtraining$bdt_elm$Form_DatePicker_Css$selectContainer, viewState.isLocked, viewState.isInput, viewState.isError),
							_1: {
								ctor: '::',
								_0: A2(
									_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
									_rtfeldman$elm_css$Html_Styled_Attributes$class('form-control'),
									viewState.isInput),
								_1: {
									ctor: '::',
									_0: A2(
									...
									_1: {
										...
										_0: A2(
											_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
											_rtfeldman$elm_css$Html_Styled_Events$onFocus(
												A3(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Open, viewState.minDate, viewState.maxDate, viewState.includeTime)),
											!viewState.isLocked),
										_1: {
											ctor: '::',
											_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$selectContainerDate,
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
								...
								_0: A2(
									_rtfeldman$elm_css$Html_Styled$div,
									{
										...
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$classList(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'glyphicons glyphicons-calendar', _1: viewState.isInput},
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$UpdateSeconds = function (a) {
	return {ctor: 'UpdateSeconds', _0: a};
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$UpdateMinutes = function (a) {
	return {ctor: 'UpdateMinutes', _0: a};
};
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$UpdateHours = function (a) {
	return {ctor: 'UpdateHours', _0: a};
};
		...
		switch (_p17.ctor) {
			...
			case 'UpdateHours':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						time,
						{hours: newSelect, focusedSelect: focusedSelect}),
					{
						ctor: '::',
						_0: A2(
						...
						_1: {
							ctor: '::',
							_0: (!_elm_lang$core$Native_Utils.eq(focusedSelect, _elm_lang$core$Maybe$Nothing)) ? _elm_lang$core$Platform_Cmd$none : A2(
								_elm_lang$core$Task$attempt,
								_bluedogtraining$bdt_elm$Form_DatePicker_Internal$DomFocus,
								_elm_lang$dom$Dom$focus('FORM_DATEPICKER')),
							_1: {ctor: '[]'}
						}
					});
			case 'UpdateMinutes':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						time,
						{minutes: newSelect, focusedSelect: focusedSelect}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$core$Platform_Cmd$map,
			...
			default:
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						time,
						{seconds: newSelect, focusedSelect: focusedSelect}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$core$Platform_Cmd$map,
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$timePicker = F2(
	function (time, selectedDate) {
		var isTimeDateSelected = !_elm_lang$core$Native_Utils.eq(time.selectedDate, _elm_lang$core$Maybe$Nothing);
		var isDateSelected = !_elm_lang$core$Native_Utils.eq(selectedDate, _elm_lang$core$Maybe$Nothing);
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$timePickerSelectContainer,
						_1: {
							ctor: '::',
							_0: A2(
								_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
								_rtfeldman$elm_css$Html_Styled_Events$onMouseDown(
									_bluedogtraining$bdt_elm$Form_DatePicker_Internal$TimeMsg(
										_bluedogtraining$bdt_elm$Form_DatePicker_Internal$OpenTimeSelect(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Hours))),
								!_elm_lang$core$Native_Utils.eq(
									time.focusedSelect,
									_elm_lang$core$Maybe$Just(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Hours))),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$timePickerSelect,
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									_bluedogtraining$bdt_elm$Form_Select$render(
										A2(
											_bluedogtraining$bdt_elm$Form_Select$setId,
											'FORM_DATEPICKER_HOURS',
											A2(
												_bluedogtraining$bdt_elm$Form_Select$setToLabel,
												_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$selectToLabel,
												_bluedogtraining$bdt_elm$Form_Select$view(time.hours))))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$timePickerColon,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							_rtfeldman$elm_css$Html_Styled$div,
							{
								...
								_1: {
									...
									_0: A2(
										...
										_rtfeldman$elm_css$Html_Styled_Events$onMouseDown(
											_bluedogtraining$bdt_elm$Form_DatePicker_Internal$TimeMsg(
												_bluedogtraining$bdt_elm$Form_DatePicker_Internal$OpenTimeSelect(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Minutes))),
										!_elm_lang$core$Native_Utils.eq(
											time.focusedSelect,
											_elm_lang$core$Maybe$Just(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Minutes))),
									_1: {ctor: '[]'}
								}
							},
							{
											...
											_bluedogtraining$bdt_elm$Form_Select$render(
												A2(
													...
													A2(
														_bluedogtraining$bdt_elm$Form_Select$setToLabel,
														_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$selectToLabel,
														_bluedogtraining$bdt_elm$Form_Select$view(time.minutes))))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
									...
									_rtfeldman$elm_css$Html_Styled$div,
									{
										...
										_1: {
											...
											_0: A2(
												...
												_rtfeldman$elm_css$Html_Styled_Events$onMouseDown(
													_bluedogtraining$bdt_elm$Form_DatePicker_Internal$TimeMsg(
														_bluedogtraining$bdt_elm$Form_DatePicker_Internal$OpenTimeSelect(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Seconds))),
												!_elm_lang$core$Native_Utils.eq(
													time.focusedSelect,
													_elm_lang$core$Maybe$Just(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$Seconds))),
											_1: {ctor: '[]'}
										}
									},
									{
													...
													_bluedogtraining$bdt_elm$Form_Select$render(
														A2(
															...
															A2(
																_bluedogtraining$bdt_elm$Form_Select$setToLabel,
																_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$selectToLabel,
																_bluedogtraining$bdt_elm$Form_Select$view(time.seconds))))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Html_Styled$text('Apply'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$timePickerContainer = F2(
	function (state, includeTime) {
		return A2(
			_bluedogtraining$bdt_elm$Html_Bdt$viewIf,
			includeTime,
			A2(
				_bluedogtraining$bdt_elm$Form_DatePicker_Internal$timePicker,
				state.time,
				_bluedogtraining$bdt_elm$Resettable$getValue(state.selectedDate)));
	});
	...
	function (state, viewState) {
		...
		if (_p36.ctor === 'Nothing') {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendar,
					_1: {
						ctor: '::',
						_0: A2(
							_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
							_bluedogtraining$bdt_elm$Form_DatePicker_Internal$disableMouseDown,
							!_bluedogtraining$bdt_elm$Form_DatePicker_Helpers$isTimeFocused(state.time)),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _bluedogtraining$bdt_elm$Form_DatePicker_Css$calendarWeekDays,
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
								_bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendarWeekDay,
								{
									ctor: '::',
									_0: 'mon',
									_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$timePickerContainer, state, viewState.includeTime),
								_1: {
									ctor: '::',
									_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$clearDateContainer, state, viewState),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _bluedogtraining$bdt_elm$Form_DatePicker_Internal$open = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				_rtfeldman$elm_css$Html_Styled$div,
				...
				},
				{
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$tabindex(0),
								_1: {
									ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$calendar, state, viewState),
						_1: {ctor: '[]'}
					}
				}));
	});
...
var _bluedogtraining$bdt_elm$Form_DatePicker$getId = function (_p0) {
	var _p1 = _p0;
	return _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getId(_p1._1);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$getSelectedDate = function (_p2) {
	var _p3 = _p2;
	return _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getSelectedDate(_p3._0);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$getInitialDate = function (_p4) {
	var _p5 = _p4;
	return _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getInitialDate(_p5._0);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$getIsOpen = function (_p6) {
	var _p7 = _p6;
	return _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getIsOpen(_p7._0);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$getIsChanged = function (_p8) {
	var _p9 = _p8;
	return _bluedogtraining$bdt_elm$Form_DatePicker_Internal$getIsChanged(_p9._0);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$render = function (_p10) {
	var _p11 = _p10;
	return A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$render, _p11._0, _p11._1);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _bluedogtraining$bdt_elm$Form_DatePicker$init = _bluedogtraining$bdt_elm$Form_DatePicker$Model(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$init);
var _bluedogtraining$bdt_elm$Form_DatePicker$update = F2(
	function (msg, _p12) {
		var _p13 = _p12;
		return A2(
			_elm_lang$core$Tuple$mapFirst,
			_bluedogtraining$bdt_elm$Form_DatePicker$Model,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$update, msg, _p13._0));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$reInitialise = function (_p14) {
	var _p15 = _p14;
	return _bluedogtraining$bdt_elm$Form_DatePicker$Model(
		_bluedogtraining$bdt_elm$Form_DatePicker_Internal$reInitialise(_p15._0));
};
var _bluedogtraining$bdt_elm$Form_DatePicker$reset = function (_p16) {
	var _p17 = _p16;
	return _bluedogtraining$bdt_elm$Form_DatePicker$Model(
		_bluedogtraining$bdt_elm$Form_DatePicker_Internal$reset(_p17._0));
};
var _bluedogtraining$bdt_elm$Form_DatePicker$setInitialDate = F2(
	function (selectedDate, _p18) {
		var _p19 = _p18;
		return _bluedogtraining$bdt_elm$Form_DatePicker$Model(
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setInitialDate, selectedDate, _p19._0));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setSelectedDate = F2(
	function (selectedDate, _p20) {
		var _p21 = _p20;
		return _bluedogtraining$bdt_elm$Form_DatePicker$Model(
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setSelectedDate, selectedDate, _p21._0));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$View = F2(
	function (a, b) {
		return {ctor: 'View', _0: a, _1: b};
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$view = function (_p22) {
	var _p23 = _p22;
	return A2(_bluedogtraining$bdt_elm$Form_DatePicker$View, _p23._0, _bluedogtraining$bdt_elm$Form_DatePicker_Internal$initialViewState);
};
var _bluedogtraining$bdt_elm$Form_DatePicker$setMinDate = F2(
	function (date, _p24) {
		var _p25 = _p24;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p25._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setMinDate, date, _p25._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setMaxDate = F2(
	function (date, _p26) {
		var _p27 = _p26;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p27._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setMaxDate, date, _p27._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setIncludeTime = F2(
	function (includeTime, _p28) {
		var _p29 = _p28;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p29._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIncludeTime, includeTime, _p29._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setIsInput = F2(
	function (isInput, _p30) {
		var _p31 = _p30;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p31._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsInput, isInput, _p31._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setIsError = F2(
	function (isError, _p32) {
		var _p33 = _p32;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p33._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsError, isError, _p33._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setIsLocked = F2(
	function (isLocked, _p34) {
		var _p35 = _p34;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p35._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsLocked, isLocked, _p35._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setIsClearable = F2(
	function (isClearable, _p36) {
		var _p37 = _p36;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p37._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setIsClearable, isClearable, _p37._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setDefaultLabel = F2(
	function (defaultLabel, _p38) {
		var _p39 = _p38;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p39._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setDefaultLabel, defaultLabel, _p39._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setToLabel = F2(
	function (toLabel, _p40) {
		var _p41 = _p40;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
			_p41._0,
			A2(_bluedogtraining$bdt_elm$Form_DatePicker_Internal$setToLabel, toLabel, _p41._1));
	});
var _bluedogtraining$bdt_elm$Form_DatePicker$setId = F2(
	function (id, _p42) {
		var _p43 = _p42;
		return A2(
			_bluedogtraining$bdt_elm$Form_DatePicker$View,
...
var _bluedogtraining$bdt_elm$Form_Input_Css$inputField = F2(
	function (isLocked, isError) {
		return _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getId = function (_) {
	return _.id;
};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$stringToMaybeInt = function (string) {
	var _p0 = string;
	if (_p0 === '') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		var _p1 = _elm_lang$core$String$toFloat(_p0);
		if (_p1.ctor === 'Err') {
			return _elm_lang$core$Native_Utils.crashCase(
				'Form.FloatInput.Internal',
				{
					start: {line: 203, column: 13},
					end: {line: 209, column: 29}
				},
				_p1)('Failed to parse FloatInput String to Float');
		} else {
			return _elm_lang$core$Maybe$Just(_p1._0);
		}
	}
};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getValue = function (_p3) {
	return _bluedogtraining$bdt_elm$Form_FloatInput_Internal$stringToMaybeInt(
		_bluedogtraining$bdt_elm$Resettable$getValue(
			function (_) {
				return _.value;
			}(_p3)));
};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getInitialValue = function (_p4) {
	return _bluedogtraining$bdt_elm$Form_FloatInput_Internal$stringToMaybeInt(
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getIsChanged = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getIsChanged(state.value);
};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setId = F2(
	function (id, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setIsError = F2(
	function (isError, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isError: isError});
	});
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setIsLocked = F2(
	function (isLocked, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isLocked: isLocked});
	});
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setPlaceholder = F2(
	function (placeholder, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{placeholder: placeholder});
	});
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setMaxLength = F2(
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setDecimal = F2(
	function (decimal, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{decimal: decimal});
	});
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setValue = F2(
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$setInitialValue = F2(
	function (value, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$reset = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$reInitialise = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			value: _bluedogtraining$bdt_elm$Resettable$init(
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$update = F2(
	function (_p5, state) {
		var _p6 = _p5;
		var _p8 = _p6._0;
		var _p7 = A2(
			...
			_elm_lang$core$Regex$regex(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(state.decimal),
						'})?$'))),
			_p8);
		if (_p7 === true) {
			return _elm_lang$core$Native_Utils.update(
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$initialViewState = {maxLength: _elm_lang$core$Maybe$Nothing, placeholder: '', isLocked: false, isError: false, id: _elm_lang$core$Maybe$Nothing};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$init = {
	value: _bluedogtraining$bdt_elm$Resettable$init(''),
	decimal: 0
};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$State = F2(
	function (a, b) {
		return {value: a, decimal: b};
	});
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$ViewState = F5(
	function (a, b, c, d, e) {
		return {maxLength: a, placeholder: b, isLocked: c, isError: d, id: e};
	});
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$inputField = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				...
				{
					ctor: '::',
					_0: A2(_bluedogtraining$bdt_elm$Form_Input_Css$inputField, viewState.isLocked, viewState.isError),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('form-control'),
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$Input),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$placeholder(viewState.placeholder),
										_1: {
											ctor: '::',
											_0: A2(_bluedogtraining$bdt_elm$Html_Bdt$maybeAttribute, _rtfeldman$elm_css$Html_Styled_Attributes$maxlength, viewState.maxLength),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _bluedogtraining$bdt_elm$Form_FloatInput_Internal$render = F2(
	function (state, viewState) {
		return A3(_rtfeldman$elm_css$Html_Styled_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_FloatInput_Internal$inputField, state, viewState);
	});

var _bluedogtraining$bdt_elm$Form_FloatInput$getId = function (_p0) {
	var _p1 = _p0;
	return _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getId(_p1._1);
};
var _bluedogtraining$bdt_elm$Form_FloatInput$getValue = function (_p2) {
	var _p3 = _p2;
	return _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getValue(_p3._0);
};
var _bluedogtraining$bdt_elm$Form_FloatInput$getInitialValue = function (_p4) {
	var _p5 = _p4;
	return _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getInitialValue(_p5._0);
};
var _bluedogtraining$bdt_elm$Form_FloatInput$getIsChanged = function (_p6) {
	var _p7 = _p6;
	return _bluedogtraining$bdt_elm$Form_FloatInput_Internal$getIsChanged(_p7._0);
};
var _bluedogtraining$bdt_elm$Form_FloatInput$render = function (_p8) {
	var _p9 = _p8;
	return A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$render, _p9._0, _p9._1);
};
var _bluedogtraining$bdt_elm$Form_FloatInput$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _bluedogtraining$bdt_elm$Form_FloatInput$init = _bluedogtraining$bdt_elm$Form_FloatInput$Model(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$init);
var _bluedogtraining$bdt_elm$Form_FloatInput$update = F2(
	function (msg, _p10) {
		var _p11 = _p10;
		return _bluedogtraining$bdt_elm$Form_FloatInput$Model(
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$update, msg, _p11._0));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$reInitialise = function (_p12) {
	var _p13 = _p12;
	return _bluedogtraining$bdt_elm$Form_FloatInput$Model(
		_bluedogtraining$bdt_elm$Form_FloatInput_Internal$reInitialise(_p13._0));
};
var _bluedogtraining$bdt_elm$Form_FloatInput$reset = function (_p14) {
	var _p15 = _p14;
	return _bluedogtraining$bdt_elm$Form_FloatInput$Model(
		_bluedogtraining$bdt_elm$Form_FloatInput_Internal$reset(_p15._0));
};
var _bluedogtraining$bdt_elm$Form_FloatInput$setInitialValue = F2(
	function (value, _p16) {
		var _p17 = _p16;
		return _bluedogtraining$bdt_elm$Form_FloatInput$Model(
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setInitialValue, value, _p17._0));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$setValue = F2(
	function (value, _p18) {
		var _p19 = _p18;
		return _bluedogtraining$bdt_elm$Form_FloatInput$Model(
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setValue, value, _p19._0));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$setDecimal = F2(
	function (decimal, _p20) {
		var _p21 = _p20;
		return _bluedogtraining$bdt_elm$Form_FloatInput$Model(
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setDecimal, decimal, _p21._0));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$View = F2(
	function (a, b) {
		return {ctor: 'View', _0: a, _1: b};
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$view = function (_p22) {
	var _p23 = _p22;
	return A2(_bluedogtraining$bdt_elm$Form_FloatInput$View, _p23._0, _bluedogtraining$bdt_elm$Form_FloatInput_Internal$initialViewState);
};
var _bluedogtraining$bdt_elm$Form_FloatInput$setMaxLength = F2(
	function (maxLength, _p24) {
		var _p25 = _p24;
		return A2(
			_bluedogtraining$bdt_elm$Form_FloatInput$View,
			_p25._0,
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setMaxLength, maxLength, _p25._1));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$setPlaceholder = F2(
	function (placeholder, _p26) {
		var _p27 = _p26;
		return A2(
			_bluedogtraining$bdt_elm$Form_FloatInput$View,
			_p27._0,
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setPlaceholder, placeholder, _p27._1));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$setIsLocked = F2(
	function (isLocked, _p28) {
		var _p29 = _p28;
		return A2(
			_bluedogtraining$bdt_elm$Form_FloatInput$View,
			_p29._0,
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setIsLocked, isLocked, _p29._1));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$setIsError = F2(
	function (isError, _p30) {
		var _p31 = _p30;
		return A2(
			_bluedogtraining$bdt_elm$Form_FloatInput$View,
			_p31._0,
			A2(_bluedogtraining$bdt_elm$Form_FloatInput_Internal$setIsError, isError, _p31._1));
	});
var _bluedogtraining$bdt_elm$Form_FloatInput$setId = F2(
	function (id, _p32) {
		var _p33 = _p32;
		return A2(
			_bluedogtraining$bdt_elm$Form_FloatInput$View,
...
var _bluedogtraining$bdt_elm$Form_IntInput_Internal$State = function (a) {
	return {value: a};
};
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(
									isDisabled ? _rtfeldman$elm_css$Css$hex('eceeef') : (((!isDisabled) && isFocused) ? _rtfeldman$elm_css$Css$hex('dddddd') : _rtfeldman$elm_css$Css$hex('ffffff'))),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$hover(
										{
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Css$optionList = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
		_1: {
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Css$optionText = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$whiteSpace(_rtfeldman$elm_css$Css$noWrap),
		_1: {
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Css$optionTextContainer = F2(
	function (isLocked, isError) {
		return _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getIsOpen = function (_) {
	return _.isOpen;
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getSelectedOptions = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getValue(state.selectedOptions);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getInitialOptions = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getInitialValue(state.selectedOptions);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getIsChanged = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getIsChanged(state.selectedOptions);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setId = F2(
	function (id, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsClearable = F2(
	function (isClearable, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isClearable: isClearable});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsError = F2(
	function (isError, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isError: isError});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsLocked = F2(
	function (isLocked, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isLocked: isLocked});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsOptionDisabled = F2(
	function (isOptionDisabled, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isOptionDisabled: isOptionDisabled});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setDefaultLabel = F2(
	function (defaultLabel, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{defaultLabel: defaultLabel});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setToLabel = F2(
	function (toLabel, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{toLabel: toLabel});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setSelectedOptions = F2(
	function (selectedOptions, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
				selectedOptions: A2(_bluedogtraining$bdt_elm$Resettable$update, selectedOptions, state.selectedOptions)
			});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setInitialOptions = F2(
	function (selectedOptions, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
				selectedOptions: _bluedogtraining$bdt_elm$Resettable$init(selectedOptions)
			});
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$reset = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			selectedOptions: _bluedogtraining$bdt_elm$Resettable$reset(state.selectedOptions)
		});
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$reInitialise = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			selectedOptions: _bluedogtraining$bdt_elm$Resettable$init(
				_bluedogtraining$bdt_elm$Resettable$getValue(state.selectedOptions))
		});
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$toLabelList = F2(
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$optionText = F3(
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$String$concat(
						A2(
							_elm_lang$core$List$map,
							_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$toLabelList(toLabel),
							_bluedogtraining$bdt_elm$Resettable$getValue(selectedOptions)))));
		}
	});
		...
		var maybeNextOption = _elm_lang$core$List$head(
			A2(
				...
				A2(
					...
					_mgold$elm_nonempty_list$List_Nonempty$toList(options))));
		var _p1 = maybeNextOption;
		if (_p1.ctor === 'Nothing') {
			return option;
		} else {
			return _p1._0;
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$focusPreviousOption = F2(
	function (options, option) {
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$focusNextOption,
			_mgold$elm_nonempty_list$List_Nonempty$reverse(options),
			option);
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$toggleOption = F2(
	function (option, selectedOptions) {
		...
		if (_p2 === true) {
			...
			return {
				ctor: '::',
				_0: option,
				_1: _bluedogtraining$bdt_elm$Resettable$getValue(selectedOptions)
			};
		}
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$focusOption = F2(
	function (options, option) {
		var _p3 = A2(_mgold$elm_nonempty_list$List_Nonempty$member, option, options);
		if (_p3 === true) {
			return option;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$unselectOption = F2(
	function (selectedOptions, option) {
		...
		if (_p5 === true) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'MULTISELECT ERROR - can\'t unselect ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(option),
						' it isn\'t selected')));
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$selectOption = F2(
	function (state, option) {
		var _p7 = A2(_mgold$elm_nonempty_list$List_Nonempty$member, option, state.options);
		if (_p7 === true) {
			return {
				ctor: '::',
				_0: option,
				_1: _bluedogtraining$bdt_elm$Resettable$getValue(state.selectedOptions)
			};
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Form.MultiSelect.Internal',
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'MULTISELECT ERROR - can\'t select ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(option),
						' is not a valid option for this select.')));
		}
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$initialViewState = {
	isLocked: false,
	isClearable: false,
	isError: false,
	isOptionDisabled: _elm_lang$core$Basics$always(false),
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$init = function (options) {
	return {
		isOpen: false,
		options: options,
		selectedOptions: _bluedogtraining$bdt_elm$Resettable$init(
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$State = F4(
	function (a, b, c, d) {
		return {isOpen: a, options: b, selectedOptions: c, focusedOption: d};
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$ViewState = F7(
	function (a, b, c, d, e, f, g) {
		return {isLocked: a, isClearable: b, isError: c, isOptionDisabled: d, toLabel: e, defaultLabel: f, id: g};
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$DomFocus = function (a) {
	return {ctor: 'DomFocus', _0: a};
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$handleKeyboardInput = F3(
	function (state, isOptionDisabled, keyboardInput) {
		...
		if (_p9.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					...
					{
						focusedOption: _elm_lang$core$Maybe$Just(
							_mgold$elm_nonempty_list$List_Nonempty$head(state.options))
					}),
				{ctor: '[]'});
		} else {
			var _p13 = _p9._0;
			var _p10 = keyboardInput;
			switch (_p10.ctor) {
				case 'Enter':
					var _p11 = isOptionDisabled;
					if (_p11 === true) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							state,
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								state,
								{
									selectedOptions: A2(
										_bluedogtraining$bdt_elm$Resettable$update,
										A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$toggleOption, _p13, state.selectedOptions),
										state.selectedOptions)
								}),
							{ctor: '[]'});
					}
				case 'Space':
					var _p12 = isOptionDisabled;
					if (_p12 === true) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							state,
				...
				case 'Up':
					var newFocusedOption = A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$focusPreviousOption, state.options, _p13);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
							...
							}),
						{
							...
							_0: A2(
								_elm_lang$core$Task$attempt,
								_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$DomFocus,
								_elm_lang$dom$Dom$focus(
									_bluedogtraining$bdt_elm$Form_Helpers$toHtmlId(newFocusedOption))),
							_1: {ctor: '[]'}
						});
				default:
					var newFocusedOption = A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$focusNextOption, state.options, _p13);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
	...
	function (msg, state) {
		var _p14 = function () {
			...
			switch (_p15.ctor) {
				...
				case 'BlurOption':
					var _p17 = _elm_lang$core$Native_Utils.eq(
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							state,
							{
								selectedOptions: A2(
									_bluedogtraining$bdt_elm$Resettable$update,
									A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$selectOption, state, _p15._0),
									state.selectedOptions)
							}),
						{ctor: '[]'});
				case 'Unselect':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							state,
							{
								selectedOptions: A2(
									_bluedogtraining$bdt_elm$Resettable$update,
									A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$unselectOption, state.selectedOptions, _p15._0),
									state.selectedOptions)
							}),
						{ctor: '[]'});
				case 'Clear':
					return A2(
						...
						{ctor: '[]'});
				case 'KeyboardInput':
					return A3(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$handleKeyboardInput, state, _p15._0, _p15._1);
				case 'Focus':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							...
							{
								focusedOption: _elm_lang$core$Maybe$Just(
									A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$focusOption, state.options, _p15._0))
							}),
						{ctor: '[]'});
				default:
					return A2(
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Focus = function (a) {
	return {ctor: 'Focus', _0: a};
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$KeyboardInput = F2(
	function (a, b) {
		return {ctor: 'KeyboardInput', _0: a, _1: b};
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Clear = {ctor: 'Clear'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Unselect = function (a) {
	return {ctor: 'Unselect', _0: a};
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Select = function (a) {
	return {ctor: 'Select', _0: a};
};
	...
	function (selectedOptions, option) {
		...
		if (_p18 === true) {
			return A3(
				...
				{stopPropagation: false, preventDefault: true},
				_elm_lang$core$Json_Decode$succeed(
					_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Unselect(option)));
		} else {
			return A3(
				_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
				'mousedown',
				{stopPropagation: false, preventDefault: true},
				_elm_lang$core$Json_Decode$succeed(
					_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Select(option)));
		}
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Blur = {ctor: 'Blur'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Open = {ctor: 'Open'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$closed = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				_rtfeldman$elm_css$Html_Styled$div,
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Css$optionTextContainer, viewState.isLocked, viewState.isError),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _bluedogtraining$bdt_elm$Form_MultiSelect_Css$optionText,
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$title(
											A3(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$optionText, viewState.defaultLabel, viewState.toLabel, state.selectedOptions)),
										_1: {ctor: '[]'}
									}
								},
								{
							...
							_1: {
								...
								_0: A2(
									_rtfeldman$elm_css$Html_Styled$div,
									{
										...
										_0: A2(
											_bluedogtraining$bdt_elm$Html_Bdt_ops['?'],
											_rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons glyphicons-chevron-down'),
											!viewState.isLocked),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Down = {ctor: 'Down'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Up = {ctor: 'Up'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Space = {ctor: 'Space'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Enter = {ctor: 'Enter'};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$isSelectInputKey = F2(
	function (msg, code) {
		var dict = _elm_lang$core$Dict$fromList(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 13, _1: _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Enter},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 32, _1: _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Space},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 38, _1: _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Up},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 40, _1: _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Down},
							_1: {ctor: '[]'}
						}
					}
				}
			});
		var _p19 = A2(_elm_lang$core$Dict$get, code, dict);
		if (_p19.ctor === 'Just') {
			return _elm_lang$core$Json_Decode$succeed(
				msg(_p19._0));
		} else {
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$onKeyboardInput = function (msg) {
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'keydown',
		{preventDefault: true, stopPropagation: true},
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$isSelectInputKey(msg),
			_rtfeldman$elm_css$Html_Styled_Events$keyCode));
};
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$optionItem = F3(
	function (state, viewState, option) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('glyphicons'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$classList(
								{
...
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$optionList = F2(
	function (state, viewState) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
			...
			A2(
				_elm_lang$core$List$map,
				A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$optionItem, state, viewState),
				_mgold$elm_nonempty_list$List_Nonempty$toList(state.options)));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$open = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				_rtfeldman$elm_css$Html_Styled$div,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onBlur(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$Blur),
								_1: {
									ctor: '::',
									_0: _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$onKeyboardInput(
										_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$KeyboardInput(false)),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$optionList, state, viewState),
						_1: {ctor: '[]'}
					}
				}));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$render = F2(
	function (state, viewState) {
		var _p20 = state.isOpen;
		if (_p20 === false) {
			return A3(_rtfeldman$elm_css$Html_Styled_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$closed, state, viewState);
		} else {
			return A3(_rtfeldman$elm_css$Html_Styled_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$open, state, viewState);
		}
	});

var _bluedogtraining$bdt_elm$Form_MultiSelect$getId = function (_p0) {
	var _p1 = _p0;
	return _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getId(_p1._1);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$getSelectedOptions = function (_p2) {
	var _p3 = _p2;
	return _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getSelectedOptions(_p3._0);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$getInitialOptions = function (_p4) {
	var _p5 = _p4;
	return _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getInitialOptions(_p5._0);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$getIsOpen = function (_p6) {
	var _p7 = _p6;
	return _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getIsOpen(_p7._0);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$getIsChanged = function (_p8) {
	var _p9 = _p8;
	return _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$getIsChanged(_p9._0);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$render = function (_p10) {
	var _p11 = _p10;
	return A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$render, _p11._0, _p11._1);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$init = function (_p12) {
	return _bluedogtraining$bdt_elm$Form_MultiSelect$Model(
		_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$init(_p12));
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$update = F2(
	function (msg, _p13) {
		var _p14 = _p13;
		return A2(
			_elm_lang$core$Tuple$mapFirst,
			_bluedogtraining$bdt_elm$Form_MultiSelect$Model,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$update, msg, _p14._0));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$reInitialise = function (_p15) {
	var _p16 = _p15;
	return _bluedogtraining$bdt_elm$Form_MultiSelect$Model(
		_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$reInitialise(_p16._0));
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$reset = function (_p17) {
	var _p18 = _p17;
	return _bluedogtraining$bdt_elm$Form_MultiSelect$Model(
		_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$reset(_p18._0));
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$setInitialOptions = F2(
	function (selectedOptions, _p19) {
		var _p20 = _p19;
		return _bluedogtraining$bdt_elm$Form_MultiSelect$Model(
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setInitialOptions, selectedOptions, _p20._0));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setSelectedOptions = F2(
	function (selectedOptions, _p21) {
		var _p22 = _p21;
		return _bluedogtraining$bdt_elm$Form_MultiSelect$Model(
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setSelectedOptions, selectedOptions, _p22._0));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$View = F2(
	function (a, b) {
		return {ctor: 'View', _0: a, _1: b};
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$view = function (_p23) {
	var _p24 = _p23;
	return A2(_bluedogtraining$bdt_elm$Form_MultiSelect$View, _p24._0, _bluedogtraining$bdt_elm$Form_MultiSelect_Internal$initialViewState);
};
var _bluedogtraining$bdt_elm$Form_MultiSelect$setIsOptionDisabled = F2(
	function (isOptionDisabled, _p25) {
		var _p26 = _p25;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
			_p26._0,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsOptionDisabled, isOptionDisabled, _p26._1));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setIsLocked = F2(
	function (isLocked, _p27) {
		var _p28 = _p27;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
			_p28._0,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsLocked, isLocked, _p28._1));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setIsError = F2(
	function (isError, _p29) {
		var _p30 = _p29;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
			_p30._0,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsError, isError, _p30._1));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setIsClearable = F2(
	function (isClearable, _p31) {
		var _p32 = _p31;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
			_p32._0,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setIsClearable, isClearable, _p32._1));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setToLabel = F2(
	function (toLabel, _p33) {
		var _p34 = _p33;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
			_p34._0,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setToLabel, toLabel, _p34._1));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setDefaultLabel = F2(
	function (defaultLabel, _p35) {
		var _p36 = _p35;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
			_p36._0,
			A2(_bluedogtraining$bdt_elm$Form_MultiSelect_Internal$setDefaultLabel, defaultLabel, _p36._1));
	});
var _bluedogtraining$bdt_elm$Form_MultiSelect$setId = F2(
	function (id, _p37) {
		var _p38 = _p37;
		return A2(
			_bluedogtraining$bdt_elm$Form_MultiSelect$View,
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Css$searchResultItem = function (hovered) {
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: hovered ? _rtfeldman$elm_css$Css$backgroundColor(
								_rtfeldman$elm_css$Css$hex('ddd')) : _rtfeldman$elm_css$Css$backgroundColor(
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Css$searchResultList = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
		_1: {
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Css$infoMessageContainer = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$padding2,
		...
		return _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Css$important(
						_rtfeldman$elm_css$Css$backgroundColor(
							isLocked ? A4(_rtfeldman$elm_css$Css$rgba, 245, 245, 245, 1) : A4(_rtfeldman$elm_css$Css$rgba, 255, 255, 255, 1))),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getId = function (_) {
	return _.id;
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getIsOpen = function (_) {
	return _.isOpen;
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getSelectedOption = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getValue(state.selectedOption);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getInitialOption = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getInitialValue(state.selectedOption);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getIsChanged = function (state) {
	return _bluedogtraining$bdt_elm$Resettable$getIsChanged(state.selectedOption);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setId = F2(
	function (id, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsClearable = F2(
	function (isClearable, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isClearable: isClearable});
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsError = F2(
	function (isError, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isError: isError});
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsLocked = F2(
	function (isLocked, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isLocked: isLocked});
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsOptionDisabled = F2(
	function (isOptionDisabled, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{isOptionDisabled: isOptionDisabled});
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setDefaultLabel = F2(
	function (defaultLabel, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{defaultLabel: defaultLabel});
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setToLabel = F2(
	function (toLabel, viewState) {
		return _elm_lang$core$Native_Utils.update(
			viewState,
			{toLabel: toLabel});
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setSelectedOption = F2(
	function (selectedOption, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setInitialOption = F2(
	function (selectedOption, state) {
		return _elm_lang$core$Native_Utils.update(
			state,
			{
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$reset = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			selectedOption: _bluedogtraining$bdt_elm$Resettable$reset(state.selectedOption)
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$reInitialise = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{
			selectedOption: _bluedogtraining$bdt_elm$Resettable$init(
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$infoMessageContainer = function (message) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _bluedogtraining$bdt_elm$Form_SearchSelect_Css$infoMessageContainer,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$infoMessage = function (message) {
	var _p0 = message;
	switch (_p0.ctor) {
		case 'InputMinimum':
			return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$infoMessageContainer(
				A2(
					_elm_lang$core$Basics_ops['++'],
		...
		case 'Searching':
			return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$infoMessageContainer('searching ..');
		default:
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$focusPreviousOption = F2(
	function (options, option) {
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$focusNextOption,
			_elm_lang$core$List$reverse(options),
			option);
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$focusOption = F2(
	function (options, option) {
		var _p2 = A2(_elm_lang$core$List$member, option, options);
		if (_p2 === true) {
			return option;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$initialViewState = {
	inputMinimum: 2,
	isLocked: false,
	isClearable: false,
	isError: false,
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$init = F2(
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$State = F8(
	function (a, b, c, d, e, f, g, h) {
		return {isOpen: a, input: b, searchUrl: c, isSearching: d, options: e, optionDecoder: f, selectedOption: g, focusedOption: h};
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$ViewState = F8(
	function (a, b, c, d, e, f, g, h) {
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$handleKeyboardInput = F2(
	function (state, keyboardInput) {
		var _p4 = state.focusedOption;
		if (_p4.ctor === 'Nothing') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
			...
			switch (_p5.ctor) {
				case 'Enter':
					return A2(
						...
						{ctor: '[]'});
				case 'Up':
					var newFocusedOption = A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$focusPreviousOption, state.options, _p6);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
							...
							}),
						{
							...
							_0: A2(
								_elm_lang$core$Task$attempt,
								_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$DomFocus,
								_elm_lang$dom$Dom$focus(
									_bluedogtraining$bdt_elm$Form_Helpers$toHtmlId(newFocusedOption))),
							_1: {ctor: '[]'}
						});
				default:
					var newFocusedOption = A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$focusNextOption, state.options, _p6);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							state,
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$BlurOption = function (a) {
	return {ctor: 'BlurOption', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Focus = function (a) {
	return {ctor: 'Focus', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$KeyboardInput = function (a) {
	return {ctor: 'KeyboardInput', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Clear = {ctor: 'Clear'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$SelectOption = function (a) {
	return {ctor: 'SelectOption', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Response = function (a) {
	return {ctor: 'Response', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchRequest = F3(
		...
		var _p7 = function () {
			...
			switch (_p8.ctor) {
				...
				case 'UpdateSearchInput':
					...
					var _p10 = _p8._0;
					var cmd = function () {
						var _p9 = A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$shouldSearch, _p10, _p11);
						if (_p9 === true) {
							return A3(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchRequest, state.searchUrl, _p11, state.optionDecoder);
						} else {
							return _elm_lang$core$Platform_Cmd$none;
						}
					}();
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								input: _p11,
								isSearching: A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$shouldSearch, _p10, _p11)
							}),
						{
							ctor: '::',
							_0: cmd,
				...
				case 'Response':
					...
					if (_p12.ctor === 'Err') {
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								state,
								{isSearching: false, options: _p12._0.options, focusedOption: _elm_lang$core$Maybe$Nothing}),
							{ctor: '[]'});
					}
				case 'Clear':
					return A2(
				...
				case 'KeyboardInput':
					return A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$handleKeyboardInput, state, _p8._0);
				case 'Focus':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							...
							{
								focusedOption: _elm_lang$core$Maybe$Just(
									A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$focusOption, state.options, _p8._0))
							}),
						{ctor: '[]'});
				case 'BlurOption':
					return _elm_lang$core$Native_Utils.eq(
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$UpdateSearchInput = F2(
	function (a, b) {
		return {ctor: 'UpdateSearchInput', _0: a, _1: b};
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Blur = {ctor: 'Blur'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Open = {ctor: 'Open'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$closed = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				_rtfeldman$elm_css$Html_Styled$div,
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Down = {ctor: 'Down'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Up = {ctor: 'Up'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Enter = {ctor: 'Enter'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$isSelectInputKey = F2(
	function (msg, code) {
		var dict = _elm_lang$core$Dict$fromList(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 13, _1: _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Enter},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 38, _1: _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Up},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 40, _1: _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Down},
						_1: {ctor: '[]'}
					}
				}
			});
		var _p13 = A2(_elm_lang$core$Dict$get, code, dict);
		if (_p13.ctor === 'Just') {
			return _elm_lang$core$Json_Decode$succeed(
				msg(_p13._0));
		} else {
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$onKeyboardInput = function (msg) {
	return A3(
		_rtfeldman$elm_css$Html_Styled_Events$onWithOptions,
		'keydown',
		{preventDefault: true, stopPropagation: true},
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$isSelectInputKey(msg),
			_rtfeldman$elm_css$Html_Styled_Events$keyCode));
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResultItem = F3(
	function (focusedOption, toLabel, option) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_SearchSelect_Css$searchResultItem(
					_elm_lang$core$Native_Utils.eq(
						_elm_lang$core$Maybe$Just(option),
						focusedOption)),
				_1: {
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResultList = F2(
	function (state, viewState) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				_0: _bluedogtraining$bdt_elm$Form_SearchSelect_Css$searchResultList,
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResultItem, state.focusedOption, viewState.toLabel),
				state.options));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$NoResults = {ctor: 'NoResults'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$Searching = {ctor: 'Searching'};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$InputMinimum = function (a) {
	return {ctor: 'InputMinimum', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResults = F2(
	function (state, viewState) {
		var _p14 = A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$shouldSearch, viewState.inputMinimum, state.input);
		if (_p14 === false) {
			...
			if (_p15 === true) {
				...
				var _p16 = _elm_lang$core$List$isEmpty(state.options);
				if (_p16 === true) {
...
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$open = F2(
	function (state, viewState) {
		return _rtfeldman$elm_css$Html_Styled$toUnstyled(
			A2(
				_rtfeldman$elm_css$Html_Styled$div,
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$searchResults, state, viewState),
						_1: {ctor: '[]'}
					}
				}));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$render = F2(
	function (state, viewState) {
		var _p17 = state.isOpen;
		if (_p17 === false) {
			return A3(_rtfeldman$elm_css$Html_Styled_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$closed, state, viewState);
		} else {
			return A3(_rtfeldman$elm_css$Html_Styled_Lazy$lazy2, _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$open, state, viewState);
		}
	});

var _bluedogtraining$bdt_elm$Form_SearchSelect$getId = function (_p0) {
	var _p1 = _p0;
	return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getId(_p1._1);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$getSelectedOption = function (_p2) {
	var _p3 = _p2;
	return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getSelectedOption(_p3._0);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$getInitialOption = function (_p4) {
	var _p5 = _p4;
	return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getInitialOption(_p5._0);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$getIsOpen = function (_p6) {
	var _p7 = _p6;
	return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getIsOpen(_p7._0);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$getIsChanged = function (_p8) {
	var _p9 = _p8;
	return _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$getIsChanged(_p9._0);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$render = function (_p10) {
	var _p11 = _p10;
	return A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$render, _p11._0, _p11._1);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$init = F2(
	function (searchUrl, optionDecoder) {
		return _bluedogtraining$bdt_elm$Form_SearchSelect$Model(
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$init, searchUrl, optionDecoder));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$update = F2(
	function (msg, _p12) {
		var _p13 = _p12;
		return A2(
			_elm_lang$core$Tuple$mapFirst,
			_bluedogtraining$bdt_elm$Form_SearchSelect$Model,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$update, msg, _p13._0));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$reInitialise = function (_p14) {
	var _p15 = _p14;
	return _bluedogtraining$bdt_elm$Form_SearchSelect$Model(
		_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$reInitialise(_p15._0));
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$reset = function (_p16) {
	var _p17 = _p16;
	return _bluedogtraining$bdt_elm$Form_SearchSelect$Model(
		_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$reset(_p17._0));
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$setInitialOption = F2(
	function (selectedOption, _p18) {
		var _p19 = _p18;
		return _bluedogtraining$bdt_elm$Form_SearchSelect$Model(
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setInitialOption, selectedOption, _p19._0));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setSelectedOption = F2(
	function (selectedOption, _p20) {
		var _p21 = _p20;
		return _bluedogtraining$bdt_elm$Form_SearchSelect$Model(
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setSelectedOption, selectedOption, _p21._0));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$View = F2(
	function (a, b) {
		return {ctor: 'View', _0: a, _1: b};
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$view = function (_p22) {
	var _p23 = _p22;
	return A2(_bluedogtraining$bdt_elm$Form_SearchSelect$View, _p23._0, _bluedogtraining$bdt_elm$Form_SearchSelect_Internal$initialViewState);
};
var _bluedogtraining$bdt_elm$Form_SearchSelect$setIsOptionDisabled = F2(
	function (isOptionDisabled, _p24) {
		var _p25 = _p24;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
			_p25._0,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsOptionDisabled, isOptionDisabled, _p25._1));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setIsLocked = F2(
	function (isLocked, _p26) {
		var _p27 = _p26;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
			_p27._0,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsLocked, isLocked, _p27._1));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setIsError = F2(
	function (isError, _p28) {
		var _p29 = _p28;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
			_p29._0,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsError, isError, _p29._1));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setIsClearable = F2(
	function (isClearable, _p30) {
		var _p31 = _p30;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
			_p31._0,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setIsClearable, isClearable, _p31._1));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setToLabel = F2(
	function (toLabel, _p32) {
		var _p33 = _p32;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
			_p33._0,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setToLabel, toLabel, _p33._1));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setDefaultLabel = F2(
	function (defaultLabel, _p34) {
		var _p35 = _p34;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
			_p35._0,
			A2(_bluedogtraining$bdt_elm$Form_SearchSelect_Internal$setDefaultLabel, defaultLabel, _p35._1));
	});
var _bluedogtraining$bdt_elm$Form_SearchSelect$setId = F2(
	function (id, _p36) {
		var _p37 = _p36;
		return A2(
			_bluedogtraining$bdt_elm$Form_SearchSelect$View,
...
if (typeof _bluedogtraining$bdt_elm$Main$main !== 'undefined') {
    _bluedogtraining$bdt_elm$Main$main(Elm['Main'], 'Main', undefined);
}
